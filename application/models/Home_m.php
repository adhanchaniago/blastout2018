...
class Home_m extends CI_Model{	
	 	 	 ...
	 	 	 if	($query->num_rows() > 0) {	
	 	 	 	 ...
	 	 	 	 if($username === $user_id && $password === $user_pass){
	 	 	 	 	$this->session->set_userdata(array(
	 	 	 	 		'loginPeserta_Blastout_2018_Bklass'=>($user_id),
	 	 	 	 		'passPeserta_BklaSS_Blastout_2018_Bklass'=> md5($user_pass),
	...
	function check_logged(){	
	 	 return	
	 	 ($this->session->userdata('loginPeserta_Blastout_2018_Bklass'))?  ($this->session->userdata('passPeserta_BklaSS_Blastout_2018_Bklass'))?  ($this->session->userdata('tryOutBalairungKlatenUGM'))?  true:FALSE:FALSE:FALSE;
	 }
