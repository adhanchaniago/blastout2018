...
<html lang="en">
  <head>
    ...
    <title>Admin - BlastOut 2018</title>
    <!-- jQuery -->
    <script src="<?php echo base_url()?>assets/admin/jquery/dist/jquery.min.js"></script>
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/ico/BO144.png">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a  class="site_title"><i class="fa fa-home"></i> <span>Blastout 2018</span></a>
            </div>
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2><?php echo $this->session->userdata('skyelaztLoginAdminKlaten');?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?php echo base_url()?>Skyelazt"><i class="fa fa-home"></i> Pendaftar</a>
                  <li><a href="<?php echo base_url()?>Skyelazt/peserta"><i class="fa fa-edit"></i> Peserta</a>
                  <li><a href="<?php echo base_url()?>Skyelazt/excel"><i class="fa fa-edit"></i> Import/Export</a>
            ...
            <div class="sidebar-footer hidden-small">
                <a href="<?php echo base_url()?>Skyelazt/logout"data-toggle="tooltip" data-placement="top" title="Logout">
        ...
        <footer>
          <div class="pull-right">
            TIM IT BlastOut 2018 - Balairung Klaten Association UGM
          </div>
          <div class="clearfix"></div>
        </footer>
      </div>
  ...
  <footer>
    <script type="text/javascript">
      ...
      function reload() {
        $.ajax({
            url: "<?php echo base_url("SkyeLazt/reload")?>",
      ...
      function detail_data(id) {
        $.ajax({
                url : "<?php echo base_url('Skyelazt/detail_data/')?>"+id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
      ...
      function getUsername() {
        $.ajax({
                url : "<?php echo base_url('Skyelazt/getUsername/')?>",
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
      ...
      function cek_peserta_v(id) {
        $.ajax({
                url : "<?php echo base_url('Skyelazt/userInfo/')?>",
                type: "POST",
      ...
      function update_data1(id) {
        $.ajax({
            url : "<?php echo base_url("Skyelazt/update_data_j"); ?>",
            type: "POST",
      ...
      function update_data(id) {
        $.ajax({
            url : "<?php echo base_url("Skyelazt/update_data"); ?>",
            type: "POST",
            data:  $('#formd').serialize(),
            dataType: "JSON",
            success: function(data)
      ...
      function delete_peserta(id) {
        if(confirm('Are you sure delete this data?')){
            ...
            $.ajax({
                url : "<?php echo base_url('Skyelazt/delete')?>/"+ id,
                type: "DELETE",
                dataType: "JSON",
                success: function(data)
                {
