            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody><?php
                    ...
                    foreach ($query as $row) {
                        $no++;
                        $aksi =  '<center><button type="button"  onclick="edit_peserta('.$row['id_peserta'].')" class="btn btn-success">Acc</button> <button type="button" onclick="delete_peserta('.$row['id_peserta'].')" class="btn btn-danger">Hapus</button></center>';
                        // $link_edit = anchor('skyelazt/edit/'.$row['id_peserta'], 'Edit');
                        // $link_delete = anchor('skyelazt/delete/' .$row['id_peserta'], 'Hapus', "onclick='return confirm(\"Data yakin dihapus?\")'");
                        echo "<tr>
                        <td>" . $no . "</td>
                        <td>" . $row['nama'] . "</td>
                        <td>" . $row['no_hp'] . "</td>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Form Konfirmasi Peserta</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal " id="formd">                     
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" >
                            <select class="form-control" name="jurusan_pes" disabled="true">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" >Username
                        </label>
                        <div class="col-sm-10" >
    ...
    <div class="modal fade" id="myModalInfo" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Hasil Verifikasi</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="button" onclick="ref()" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
    </div>