...
<html >
  <head>
    ...
    <body>
      <div class="container">
        <img src="<?php echo base_url() ?>assets/cetak/saintek.jpg" alt="gambar" class="bg" />
          <!-- tambahan content -->
          <div class=" datadiri">
            <table >
              <tr>
          ...
          <div class="progstud">
            <p>Pilihan Program Studi :</p>
              <table>
                ...
                <tr>
                  <td>2. </td>
                  <td><?php echo $isi->kode_pil2." - ".$isi->nama_pil2 ?></td>
                </tr>
                <tr>
                  <td>3. </td>
                  <td><?php echo $isi->kode_pil3." - ".$isi->nama_pil3 ?></td>
                </tr>
              </table>
          </div>
      </div>
